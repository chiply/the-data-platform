...
*** WIP [Ralph] Design doc 004 - Dev Environment on Linode
:PROPERTIES:
:DESIGN: [[file:docs/design/004-dev-environment.org][004 Dev Environment on Linode]]
:DELEGATED_TO: ralph
:PRD_FILES: tasks/prd-dev-env-platform-config.json, tasks/prd-dev-env-cluster.json, tasks/prd-dev-env-scripts.json, tasks/prd-dev-env-testing-docs.json
:END:
