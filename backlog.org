...
*** DONE [Ralph] Design doc 008 - Distributed Tracing Pipeline (7/7 tasks)
:PROPERTIES:
:DESIGN: [[file:docs/design/008-distributed-tracing-pipeline.org][008 Distributed Tracing Pipeline]]
:COMPLETED_BY: ralph, claude-code, human
...
- Added fullnameOverride to pin Helm service DNS names
- Removed Ralph artifacts (progress.txt, prd json)
- Verified traces end-to-end on local (TDP-008-06)
- Verified Pulumi config keys match design doc spec (TDP-008-07)
